...
const LoginPage = () => {
  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      {/* --------- Left ----------- */}
      <img src={assets.logo_big} alt='' className='max-w-[150px]' />
     ...
     flex-col gap-6 rounded-lg shadow-lg'>
        ...
        border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'/>
            <input onChange={(e) => setPassword(e.target.value)} value={password} type='password' placeholder='Password' required className='p-2 border
        border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'/>
